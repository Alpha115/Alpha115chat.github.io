...
<div id="bo_gall" style="max-width:<?php echo $width; ?>">
    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="<?php echo implode(' ', $classes); ?><? if ($list[$i]['is_notice']) echo " bo_notice";?>">
            ...
            <!--
                ...
                <div class="gall_con">  
					<a href="javascript:<?=$board['bo_read_level']<=$member['mb_level'] ? "open_view('".$bo_table."','".$list[$i]['wr_id']."');": "void(0);";?>" class="bo_tit" >
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="ui-btn point">글쓰기</a></li><?php } ?>
            <?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" target="_black" class="admin ui-btn">관리자</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>
