...
<?}
 ...
 if($is_viewer){?>
    ...
    <!-- 게시물 상단 버튼 시작 { -->
		...
		<section id="bo_v_info" class="txt-left"> 
        <h2 id="bo_v_title" >
        ...
        <span class="if_copy"><?php echo $view['wr_1'] ?></span>　<strong class="if_date"><span class="sound_only">작성일</span><?php echo date("Y/m/d", strtotime($view['wr_datetime'])) ?></strong>
		<div class="bo_v_cate"><? echo nl2br(conv_content($view['wr_content'],1)) ?></div>
		</section> 
